...
const WorkThirdISotope = dynamic(
  () => import("../src/components/WorkThirdISotope"),
  {
    ssr: false,
  }
);
        ...
        <div className="m-image-large">
          <div className="image">
            <div
              ...
              style={{
                backgroundImage:
                  "url(	https://img.freepik.com/free-vector/online-medicine-elements-set-with-patients-getting-video-consultation-3d-isometric-isolated-illustration_1284-61136.jpg?t=st=1721719293~exp=1721722893~hmac=0b374be64d485195b0308ed548c176365cb8aaf4864c1e812451153ccb471ec2&w=1060)",
              }}
            />
          </div>
        </div>
